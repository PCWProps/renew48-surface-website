...
final class PCW_Renew48_Blocks {
    ...
    public static function visual_system_showcase_content(): string {
        ...
        return self::block('collective-header', array('title' => 'Renew48 Wellness Collective', 'eyebrow' => 'Staging visual system', 'ctaLabel' => 'Find care', 'handoff' => 'directory', 'surface' => 'translucent'))
            . self::block('mobile-menu-drawer', array('ctaLabel' => 'Find care', 'handoff' => 'directory', 'surface' => 'translucent'))
            ...
            . self::block('modal-trigger', array('eyebrow' => 'Public information', 'title' => 'Keep care conversations on the provider domain.', 'body' => 'This modal pattern carries public context only and does not collect information.', 'ctaLabel' => 'Read the boundary', 'surface' => 'translucent'))
            ...
            . self::block('social-proof-strip', array('eyebrow' => 'Trust signals', 'title' => 'Only verified public proof belongs here.', 'body' => 'This editable strip intentionally contains no invented ratings, testimonials, or clinical claims.', 'surface' => 'solid'))
